...
/* 데이터베이스 모듈 - user_schema 파일을 로딩하여 실행하는 역할 수행
   - database.init : connect 함수 호출
   - function connect : DB 연결
   - function createSchema : config.js 파일의 db_schemas 속성에 들어 있는
     스키마 정보를 사용하여 스키마 생성
*/
...
function createSchema(app, config) {
	...
	// config에 정의된 모든 스키마와 모델 객체를 가져와 처리
